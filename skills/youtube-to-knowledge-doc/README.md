...
```markdown
**Generated by:** Claude Code session `21fc9ab9-7ffd-40b7-9cac-1a5570f86e7d` (2025-11-10)
```

## Dependencies

- **yt-dlp** (install via `brew install yt-dlp` or `pip install yt-dlp`)
- **Knowledge Framework guide** (see knowledge-framework skill)
- **folder-finder skill** (determines target location - optional)
...
→ personal/learning/NN_tutorial_topic.md
```
