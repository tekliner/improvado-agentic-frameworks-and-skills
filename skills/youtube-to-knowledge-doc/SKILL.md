...
- "Document this YouTube video [URL]"
- "Create notes from [YouTube URL]"
- "Save this video to repository"
- "Convert this video to documentation"
- User provides YouTube URL and asks to preserve content
...
SESSION_ID=$(/Users/Kravtsovd/projects/chrome-extension-tcs/claude_venv/bin/python \
  /Users/Kravtsovd/projects/chrome-extension-tcs/data_sources/claude_code/get_session_id.py --quiet)
```
...
- **get_session_id.py:** Claude Code session ID extraction
  - Location: `/Users/Kravtsovd/projects/chrome-extension-tcs/data_sources/claude_code/get_session_id.py`
  - Python: `/Users/Kravtsovd/projects/chrome-extension-tcs/claude_venv/bin/python`

### File Locations
- **Temporary transcripts:** `/tmp/` (auto-cleaned)
- **Target folders:** `algorithms/` hierarchy (see folder-finder skill)
- **Knowledge Framework guide:** `/Users/Kravtsovd/projects/chrome-extension-tcs/How to organize documents_knowladge_framework.md`
- **Session ID script:** `/Users/Kravtsovd/projects/chrome-extension-tcs/data_sources/claude_code/get_session_id.py`
...
```bash
/Users/Kravtsovd/projects/chrome-extension-tcs/claude_venv/bin/python \
  /Users/Kravtsovd/projects/chrome-extension-tcs/data_sources/claude_code/get_session_id.py --quiet
```
